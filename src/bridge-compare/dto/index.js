...
let GetQuotesDto = (() => {
    ...
    return _a = class GetQuotesDto {
        ...
        (() => {
            ...
            _destinationToken_decorators = [(0, swagger_1.ApiPropertyOptional)({
            ...
            _rankingMode_decorators = [(0, swagger_1.ApiPropertyOptional)({
                    description: 'Ranking mode for route comparison',
                    enum: enums_1.RankingMode,
                    default: enums_1.RankingMode.BALANCED,
                }), (0, class_validator_1.IsOptional)(), (0, class_validator_1.IsEnum)(enums_1.RankingMode)];
            _slippageTolerance_decorators = [(0, swagger_1.ApiPropertyOptional)({
                    description: 'Max acceptable slippage %',
                    example: 0.5,
                }), (0, class_validator_1.IsOptional)(), (0, class_transformer_1.Type)(() => Number), (0, class_validator_1.IsNumber)(), (0, class_validator_1.Min)(0), (0, class_validator_1.Max)(100)];
