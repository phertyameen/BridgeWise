...
let AnalyticsModule = (() => {
    let _classDecorators = [(0, common_1.Module)({
            ...
            providers: [analytics_service_1.AnalyticsService, analytics_collector_1.AnalyticsCollector],
            exports: [analytics_service_1.AnalyticsService, analytics_collector_1.AnalyticsCollector],
        })];
    let _classDescriptor;
    let _classExtraInitializers = [];
    let _classThis;
    var AnalyticsModule = _classThis = class {
    };
