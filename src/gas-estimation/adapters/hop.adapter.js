...
let HopAdapter = (() => {
    ...
    var HopAdapter = _classThis = class {
        constructor(httpService, configService, hopService) {
            this.httpService = httpService;
            this.configService = configService;
            this.hopService = hopService;
            this.logger = new common_1.Logger(HopAdapter.name);
            ...
            this.circuitBreaker = new opossum_1.default(this.makeApiCall.bind(this), {
         ...
         */
        async getFees(token, sourceChain, destinationChain, amount) {
            ...
            for (let attempt = 1; attempt <= this.retryAttempts; attempt++) {
                try {
                    ...
                    this.logger.error(`Hop API error (attempt ${attempt}/${this.retryAttempts}):`, error.message);
...
//# sourceMappingURL=hop.adapter.js.map