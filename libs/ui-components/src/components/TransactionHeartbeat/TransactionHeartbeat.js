...
exports.BridgeStatus = exports.TransactionHeartbeat = void 0;
const react_1 = __importDefault(require("react"));
const TransactionHeartbeat_headless_1 = require("./TransactionHeartbeat.headless");
/**
 ...
 * ```
 */
const TransactionHeartbeat = ({ className, style, }) => {
    return (<TransactionHeartbeat_headless_1.TransactionHeartbeatHeadless>
      {({ state, clearState, isSuccess, isFailed, isPending }) => (<div className={`fixed bottom-4 right-4 z-50 w-80 overflow-hidden font-sans${className ? ` ${className}` : ''}`} style={{
          ...
          <div style={{ padding: 'var(--bw-spacing-md)' }}>
            {/* Header */}
            <div className="flex items-center justify-between" style={{ marginBottom: 'var(--bw-spacing-sm)' }}>
              <h3 style={{
              ...
              <button onClick={clearState} aria-label="Close" style={{
                background: 'none',
                border: 'none',
                padding: 0,
                cursor: 'pointer',
            ...
            {state.txHash && (<div style={{ marginTop: 'var(--bw-spacing-sm)' }}>
                <a href="#" style={{
                    fontSize: 'var(--bw-typography-font-size-xs)',
    ...
    </TransactionHeartbeat_headless_1.TransactionHeartbeatHeadless>);
};
exports.TransactionHeartbeat = TransactionHeartbeat;
exports.BridgeStatus = exports.TransactionHeartbeat;
