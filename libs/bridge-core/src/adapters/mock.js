...
exports.MockBridgeAdapter = void 0;
...
class MockBridgeAdapter {
    constructor(config = {}) {
        this.provider = 'hop'; // Using hop as mock provider
        this._isReady = false;
        this.requestCount = 0;
        this.config = {
    ...
    supportsChainPair(sourceChain, targetChain) {
        return this.config.supportedChainPairs.some(([s, t]) => s === sourceChain && t === targetChain);
    }
    /**
    ...
    async supportsTokenPair(sourceChain, targetChain, sourceToken, destinationToken) {
        ...
        const sourceSupported = sourceTokens.some((t) => this.normalizeToken(t) === normalizedSource);
        const destSupported = destTokens.some((t) => this.normalizeToken(t) === normalizedDest);
...
exports.MockBridgeAdapter = MockBridgeAdapter;
// Default supported chain pairs
MockBridgeAdapter.DEFAULT_CHAIN_PAIRS = [
    ['ethereum', 'polygon'],
    ['ethereum', 'arbitrum'],
    ['ethereum', 'optimism'],
    ['ethereum', 'base'],
...
MockBridgeAdapter.DEFAULT_TOKENS = {
    ethereum: [
 ...
 */
function createMockAdapter(scenario = 'happy-path') {
    const scenarios = {
        'happy-path': {
            networkDelay: 50,
            failureRate: 0,
...
exports.default = MockBridgeAdapter;
